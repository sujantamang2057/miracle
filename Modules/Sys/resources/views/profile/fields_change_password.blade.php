...
<div class="form-group col-md-6">
    <div class="bg-light px-2 pt-2">{!! Form::label('name', __('sys::models/users.fields.name') . ':') !!}</div>
...
<!-- Email Field -->
<div class="form-group col-md-6">
    <div class="bg-light px-2 pt-2">{!! Form::label('email', __('sys::models/users.fields.email') . ':') !!}</div>
    <div class="clearfix w-100"></div>
