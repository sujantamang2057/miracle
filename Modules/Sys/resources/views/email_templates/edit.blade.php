...
@section('content')
    {{ Breadcrumbs::render('emailTemplate_edit', $emailTemplate) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('sys::models/email_templates.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($emailTemplate, [
                'route' => ['sys.emailTemplates.update', $emailTemplate->template_id],
                'method' => 'patch',
            ]) !!}
            <div class="card-body">
                <div class="row">
                    @include('sys::email_templates.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="d-flex">
                    ...
                    <div class="form-group {{ validationClass($errors->has('reserved')) }}">
                        <div class="form-check mr-3 pl-0">
                            ...
                            @if (checkSysPermission('emailTemplates.toggleReserved'))
                ...
                {!! renderLinkButton(__('common::crud.cancel'), route('sys.emailTemplates.index'), 'times', 'warning', '') !!}
            </div>
