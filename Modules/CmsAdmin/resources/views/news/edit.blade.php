...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.btn.edit') }} {{ __('cmsadmin::models/news.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($news, ['route' => ['cmsadmin.news.update', $news->news_id], 'method' => 'patch', 'id' => 'news-form']) !!}
            <div class="card-body">
                <div class="row">
            ...
            <div class="card-footer">
                ...
                {!! renderPreviewButton('news-form', 'cmsadmin.news.preview', $news->news_id) !!}
            </div>
