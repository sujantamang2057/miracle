...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="resend-mail"
        data-url="{{ route('cmsadmin.contacts.resendMail', $contact?->contact_id) }}">{{ __('cmsadmin::models/contacts.resend_mail') }}</button>
</div>
