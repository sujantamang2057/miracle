...
@section('content')
    {{ Breadcrumbs::render('video_gallery_edit', $videoGallery->album, $videoGallery) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('cmsadmin::models/video_galleries.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($videoGallery, [
                'route' => ['cmsadmin.videoGalleries.update', ['videoAlbum' => $videoGallery->album_id, 'gallery' => $videoGallery->video_id]],
                'method' => 'patch',
            ]) !!}
