...
@section('content')
    {{ Breadcrumbs::render('video_album_edit', $videoAlbum) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('cmsadmin::models/video_albums.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($videoAlbum, [
                'route' => ['cmsadmin.videoAlbums.update', $videoAlbum->album_id],
                'method' => 'patch',
            ]) !!}

            <div class="card-body">
                <div class="row">
                    @include('cmsadmin::video_albums.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="d-flex">
                    ...
                    <div class="form-group {{ validationClass($errors->has('reserved')) }}">
                        <div class="form-check mr-3 pl-0">
                            ...
                            @if (checkCmsAdminPermission('videoAlbums.toggleReserved'))
                ...
                {!! renderLinkButton(__('common::crud.btn.cancel'), route('cmsadmin.videoAlbums.index'), 'times', 'warning', '') !!}
            </div>
