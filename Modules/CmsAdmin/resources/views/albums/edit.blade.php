...
@section('content')
    {{ Breadcrumbs::render('album_edit', $album) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('cmsadmin::models/albums.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($album, ['route' => ['cmsadmin.albums.update', $album->album_id], 'method' => 'patch']) !!}
            <div class="card-body">
                <div class="row">
                    @include('cmsadmin::albums.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="d-flex">
                    ...
                    <div class="form-group {{ validationClass($errors->has('reserved')) }}">
                        <div class="form-check mr-3 pl-0">
                            ...
                            @if (checkCmsAdminPermission('albums.toggleReserved'))
                ...
                {!! renderLinkButton(__('common::crud.btn.cancel'), route('cmsadmin.albums.index'), 'times', 'warning', '') !!}
            </div>
