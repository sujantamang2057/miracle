...
@section('content')
    {{ Breadcrumbs::render('block_edit', $block) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('cmsadmin::models/blocks.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($block, ['route' => ['cmsadmin.blocks.update', $block->block_id], 'method' => 'patch']) !!}
            <div class="card-body">
                <div class="row">
            ...
            <div class="card-footer">
                ...
                {!! renderLinkButton(__('common::crud.cancel'), route('cmsadmin.blocks.index'), 'times', 'warning', '') !!}
            </div>
