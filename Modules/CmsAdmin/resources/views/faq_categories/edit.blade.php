...
@section('content')
    {{ Breadcrumbs::render('faqCategory_edit', $faqCategory) }}
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>{{ __('common::crud.edit') }} {{ __('cmsadmin::models/faq_categories.singular') }}</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card mb-7">
            {!! Form::model($faqCategory, [
                'route' => ['cmsadmin.faqCategories.update', $faqCategory->faq_cat_id],
                'method' => 'patch',
            ]) !!}
            <div class="card-body">
                <div class="row">
                    @include('cmsadmin::faq_categories.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="d-flex">
                    ...
                    <div class="form-group {{ validationClass($errors->has('reserved')) }}">
                        <div class="form-check mr-3 pl-0">
                            ...
                            @if (checkCmsAdminPermission('faqCategories.toggleReserved'))
                ...
                {!! renderLinkButton(__('common::crud.btn.cancel'), route('cmsadmin.faqCategories.index'), 'times', 'warning', '') !!}
            </div>
