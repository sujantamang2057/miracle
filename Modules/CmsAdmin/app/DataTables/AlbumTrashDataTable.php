...
class AlbumTrashDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', 'cmsadmin::albums.datatables_trash_actions')
            ->rawColumns(['action', 'selection', 'publish', 'cover_image_id']);
    }
    ...
    public function html()
    {
        ...
        if (checkCmsAdminPermission('albums.permanentDestroy')) {
            $bulkActions[] = [
                ...
                'url' => route('cmsadmin.albums.permanentDestroy', [0]),
                'value' => 'delete',
            ];
        }
